...
#define link_item_boomerang        (*(INV uint8*)(g_ram+0xF341))
#define link_item_hookshot         (*(INV uint8*)(g_ram+0xF342))
#define link_item_bombs            (*(INV uint8*)(g_ram+0xF343))
#define link_item_fire_rod         (*(INV uint8*)(g_ram+0xF345))
#define link_item_ice_rod          (*(INV uint8*)(g_ram+0xF346))
#define link_item_bombos_medallion (*(INV uint8*)(g_ram+0xF347))
#define link_item_ether_medallion  (*(INV uint8*)(g_ram+0xF348))
#define link_item_quake_medallion  (*(INV uint8*)(g_ram+0xF349))
#define link_item_torch            (*(INV uint8*)(g_ram+0xF34A))
#define link_item_hammer           (*(INV uint8*)(g_ram+0xF34B))
#define link_item_bug_net          (*(INV uint8*)(g_ram+0xF34D))
#define link_item_book_of_mudora   (*(INV uint8*)(g_ram+0xF34E))
#define link_item_cane_somaria     (*(INV uint8*)(g_ram+0xF350))
#define link_item_cane_byrna       (*(INV uint8*)(g_ram+0xF351))
#define link_item_cape             (*(INV uint8*)(g_ram+0xF352))
#define link_item_mirror           (*(INV uint8*)(g_ram+0xF353))
#define link_item_boots            (*(INV uint8*)(g_ram+0xF355))
#define link_item_flippers         (*(INV uint8*)(g_ram+0xF356))
#define link_item_moon_pearl       (*(INV uint8*)(g_ram+0xF357))

#define link_item_gloves           (*(INV uint8*)(g_ram+0xF354))
#define link_item_mushroom         (*(INV uint8*)(g_ram+0xF344))
#define link_item_bow              (*(INV uint8*)(g_ram+0xF340))
#define link_item_flute            (*(INV uint8*)(g_ram+0xF34C))
#define link_sword_type            (*(INV uint8*)(g_ram+0xF359))
#define link_shield_type           (*(INV uint8*)(g_ram+0xF35A))
#define link_armor                 (*(INV uint8*)(g_ram+0xF35B))
#define link_item_bottle_index     (*(INV uint8*)(g_ram+0xF34F))
